...
class Calculadora(object):
    """Clase para crear el diseño de la calculadora, distribución de botones
     y la adición de su funcionalidad. Los botones distribuidos en el diseño son los que se muestran a continuación:"""
    ...
    def __init__(self, master):
        ...
        # Establece el estilo predeterminado para macOS, si se usa el sistema operativo
    ...
    @staticmethod
    def _load_settings():
        """Utilidad para cargar el archivo de configuración de la calculadora."""
    ...
    def _get_theme(self, name='Dark'):
        """Devuelve la configuración de estilo para el tema especificado."""
    ...
    def _create_buttons(self, master):
        """"Método responsable de crear todos los botones de la calculadora.
        """

        # Establezca la configuración global (ancho, fuente de altura, etc.) en el botón especificado.
        ...
        # Instancia de botones de operador numéricos
        ...
        # Instancia de botones de función de calculadora
        ...
        # Instancia de botones vacíos, para implementación futura
        ...
        # Distribución de botones en un administrador de diseño de cuadrícula
        # Línea de botones 0
        ...
        # Eventos de botón numérico de operaciones matematicas
        ...
        # Eventos del botón de función de la calculadora
    ...
    def _set_values_in_input(self, value):
        """Método responsable de capturar el valor numérico en el que se hizo clic y sentarse en la entrada"""
    ...
    def _clear_input(self):
        """Resetea la entrada de la calculadora, limpiándola por completo e ingresando el valor 0 ""
        self._entrada.delete(0, len(self._entrada.get()))
        self._entrada.insert(0,0)
    
    def _del_last_value_in_input(self):
        """Apaga el último dígito contenido en la entrada"""
        if self._entrada.get() == 'Erro':
            return
    ...
    def _set_operator_in_input(self, operator):
        """Método responsable de capturar el operador matemático cliqueado y configurado en la entrada"""
        if self._entrada.get() == 'Erro':
            return
        ...
        if self._entrada.get() == '':
            ...
            return
        # Evita casos de operadores repetidos secuencialmente, para evitar errores
        if self._entrada.get()[-1] not in '+-*/' and self._lenght_max(self._entrada.get()):
